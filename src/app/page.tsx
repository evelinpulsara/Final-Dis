...
export default function PortfolioLanding() {
  ...
  return (
    <div className={`min-h-screen ${isDark ? 'bg-[#0F1029]' : 'bg-[#F5F3FA]'} transition-colors duration-300`}>
        ...
        <nav className="container mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <button className={`p-2 rounded-lg transition-colors ${isDark ? 'hover:bg-[#1C1B2E]' : 'hover:bg-gray-200'}`}>
              ...
              <button
                ...
                className={`p-2 rounded-lg transition-colors ${isDark ? 'hover:bg-[#1C1B2E]' : 'hover:bg-gray-200'}`}
              >
                {isDark ? (
      ...
      {/* Sección Educación - CORREGIDA PARA MODO OSCURO */}
      <section id="educacion" className={`py-20 ${isDark ? 'bg-[#0F1029]' : 'bg-[#F5F3FA]'}`}>
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <h2 className={`text-3xl font-bold text-center mb-12 ${isDark ? 'text-white' : ''}`}>Educación</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Cuadro 1 */}
              <div className={`${isDark ? 'bg-[#1C1B2E]' : 'bg-[#E9E2F7]'} p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow`}>
                <h3 className={`text-xl font-bold mb-2 ${isDark ? 'text-white' : ''}`}>Técnico en sistemas</h3>
                <p className={`${isDark ? 'text-[#FF8989]' : 'text-gray-600'} mb-4`}>Terminado</p>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className={`font-medium ${isDark ? 'text-white' : ''}`}>SistemPlus</p>
              ...
              <div className={`${isDark ? 'bg-[#322F56]' : 'bg-[#E9E2F7]'} p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow`}>
                <h3 className={`text-xl font-bold mb-2 ${isDark ? 'text-white' : ''}`}>Técnico en electrónica</h3>
                <p className={`${isDark ? 'text-[#FF8989]' : 'text-gray-600'} mb-4`}>Terminado</p>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-white p-1">
                  ...
                  <div>
                    <p className={`font-medium ${isDark ? 'text-white' : ''}`}>Cinar Sistemas</p>
                    <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>date</p>
                  </div>
                </div>
              </div>
              ...
              <div className={`${isDark ? 'bg-[#2D255A]' : 'bg-[#E9E2F7]'} p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow`}>
                <h3 className={`text-xl font-bold mb-2 ${isDark ? 'text-white' : ''}`}>Ingeniería de software</h3>
                <p className={`${isDark ? 'text-[#4CAF50]' : 'text-gray-600'} mb-4`}>Activo</p>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-white p-1">
                  ...
                  <div>
                    <p className={`font-medium ${isDark ? 'text-white' : ''}`}>Universidad Cooperativa</p>
                    <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>----</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="conocimientos" className={`py-20 ${isDark ? 'bg-[#0F1029]' : 'bg-[#F5F3FA]'}`}>
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <h2 className={`text-3xl font-bold text-center mb-12 ${isDark ? 'text-white' : ''}`}>Conocimientos</h2>
            <div className="space-y-8">
              <div className={`${isDark ? 'bg-[#1C1B2E]' : 'bg-[#D6C8F0]'} p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow flex flex-col md:flex-row items-start gap-6`}>
                ...
                <div>
                  <h3 className={`text-xl font-bold mb-2 ${isDark ? 'text-white' : ''}`}>Java</h3>
              ...
              <div className={`${isDark ? 'bg-[#322F56]' : 'bg-[#C7D9F7]'} p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow flex flex-col md:flex-row items-start gap-6`}>
                <div className="w-20 h-20 rounded-lg bg-white p-2">
                ...
                <div>
                  <h3 className={`text-xl font-bold mb-2 ${isDark ? 'text-white' : ''}`}>Python</h3>
                  <p className={isDark ? 'text-gray-300' : 'text-gray-700'}>
              ...
              <div className={`${isDark ? 'bg-[#2D255A]' : 'bg-[#A9B7F2]'} p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow flex flex-col md:flex-row items-start gap-6`}>
                <div className="w-20 h-20 rounded-lg bg-white p-2">
                  <img src="https://cdn.worldvectorlogo.com/logos/unity-69.svg" alt="Unity Logo" className="w-full h-full object-contain" />
                </div>
                <div>
                  <h3 className={`text-xl font-bold mb-2 ${isDark ? 'text-white' : ''}`}>Unity</h3>
                  <p className={isDark ? 'text-gray-300' : 'text-gray-700'}>
      ...
      <section id="proyectos" className={`py-20 ${isDark ? 'bg-[#0F1029]' : 'bg-[#F5F3FA]'}`}>
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <h2 className={`text-3xl font-bold text-center mb-12 ${isDark ? 'text-white' : ''}`}>Proyectos</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Proyecto 1: Boleto de avión */}
              <div className={`${isDark ? 'bg-[#1C1B2E]' : 'bg-[#C7D9F7]'} p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow`}>
                <div className="mb-4">
                  <a href="https://boleto-tawny.vercel.app" target="_blank" rel="noopener noreferrer" className="block w-full h-32 rounded-lg overflow-hidden">
                    <img src="/imagenes/boleto.png" alt="Vista previa de Boleto de avión" className="w-full h-full object-cover" />
                  </a>
                </div>
                <h3 className={`text-xl font-bold mb-2 ${isDark ? 'text-white' : ''}`}>Boleto de avión</h3>
                <p className={isDark ? 'text-gray-300 mb-2' : 'text-gray-600 mb-2'}>Link GitHub:</p>
              ...
              <div className={`${isDark ? 'bg-[#322F56]' : 'bg-[#D6C8F0]'} p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow`}>
                <div className="mb-4">
                  <a href="https://invitacion-angely.vercel.app" target="_blank" rel="noopener noreferrer" className="block w-full h-32 rounded-lg overflow-hidden">
                    <img src="/imagenes/xv.png" alt="Vista previa de invitacion" className="w-full h-full object-cover" />
                  </a>
                </div>
                <h3 className={`text-xl font-bold mb-2 ${isDark ? 'text-white' : ''}`}>Invitación XV</h3>
                <p className={isDark ? 'text-gray-300 mb-2' : 'text-gray-600 mb-2'}>Link GitHub:</p>
                <ul className="list-disc pl-5 text-gray-700">
              ...
              {/* Proyecto 3: Interfaz */}
              <div className={`${isDark ? 'bg-[#2D255A]' : 'bg-[#B18BE8]'} p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow`}>
                <div className="mb-4">
                  <a href="https://taller-interfaz.vercel.app" target="_blank" rel="noopener noreferrer" className="block w-full h-32 rounded-lg overflow-hidden">
                    <img src="/imagenes/interfaz.png" alt="Vista previa de Interfaz" className="w-full h-full object-cover" />
                  </a>
                </div>
                <h3 className={`text-xl font-bold mb-2 ${isDark ? 'text-white' : ''}`}>Formulario</h3>
                <p className={isDark ? 'text-gray-300 mb-2' : 'text-gray-600 mb-2'}>Link GitHub:</p>
                <ul className="list-disc pl-5 text-gray-700">
              ...
              <div className={`${isDark ? 'bg-[#1C1B2E]' : 'bg-[#E9E2F7]'} p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow`}>
                <div className="mb-4 flex justify-center">
                  <a href="https://responsive-design-indol.vercel.app" target="_blank" rel="noopener noreferrer" className="block w-full h-32 rounded-lg overflow-hidden">
                    <img src="/imagenes/netflix.png" alt="Vista previa de Interfaz" className="w-full h-full object-cover" />
                  </a>
                </div>
                <h3 className={`text-xl font-bold mb-2 ${isDark ? 'text-white' : ''}`}>Interfaz</h3>
                <p className={isDark ? 'text-gray-300 mb-2' : 'text-gray-600 mb-2'}>Link GitHub:</p>
                <ul className="list-disc pl-5 text-gray-700">
              ...
              {/* Proyecto 5: Title 2 */}
              <div className={`${isDark ? 'bg-[#322F56]' : 'bg-[#EFD8F6]'} p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow`}>
                <div className="mb-4 flex justify-center">
                  <img src="https://cdn-icons-png.flaticon.com/512/25/25231.png" alt="GitHub Logo" className="w-20 h-20 object-contain" />
                </div>
                <h3 className={`text-xl font-bold mb-2 ${isDark ? 'text-white' : ''}`}>Title</h3>
                <p className={isDark ? 'text-gray-300 mb-2' : 'text-gray-600 mb-2'}>Link GitHub:</p>
                <ul className="list-disc pl-5 text-gray-700">
                  <li>-</li>
                </ul>
              ...
              {/* Proyecto 6: Title 3 */}
              <div className={`${isDark ? 'bg-[#2D255A]' : 'bg-[#A9B7F2]'} p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow`}>
                <div className="mb-4 flex justify-center">
                  <img src="https://cdn-icons-png.flaticon.com/512/25/25231.png" alt="GitHub Logo" className="w-20 h-20 object-contain" />
                </div>
                <h3 className={`text-xl font-bold mb-2 ${isDark ? 'text-white' : ''}`}>Title</h3>
      ...
      <section id="testimonios" className={`py-20 ${isDark ? 'bg-[#0F1029]' : 'bg-[#F5F3FA]'}`}>
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <h2 className={`text-3xl font-bold text-center mb-12 ${isDark ? 'text-white' : ''}`}>Testimonios</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Cuadro 1 */}
              <div className={`${isDark ? 'bg-[#1C1B2E] border-[#333]' : 'bg-[#D6C8F0] border-gray-300'} p-6 rounded-xl shadow-md border`}>
                <p className={`${isDark ? 'text-gray-200' : 'text-gray-800'} italic mb-4`}>
                ...
                <div className="flex items-center gap-3">
                  ...
                  />
                  <div>
                    <p className={`font-medium ${isDark ? 'text-[#B088FF]' : 'text-[#7A4FBF]'}`}>Andrea López, Docente</p>
                    <p className={`text-sm ${isDark ? 'text-[#A0A0C0]' : 'text-[#5E5A72]'}`}>15/04/2025</p>
                  </div>
                </div>
              </div>

              {/* Cuadro 2 */}
              <div className={`${isDark ? 'bg-[#322F56] border-[#333]' : 'bg-[#C7D9F7] border-gray-300'} p-6 rounded-xl shadow-md border`}>
                <p className={`${isDark ? 'text-gray-200' : 'text-gray-800'} italic mb-4`}>
                ...
                <div className="flex items-center gap-3">
                  ...
                  />
                  <div>
                    <p className={`font-medium ${isDark ? 'text-[#B088FF]' : 'text-[#7A4FBF]'}`}>Carlos Mendoza, Compañero</p>
                    <p className={`text-sm ${isDark ? 'text-[#A0A0C0]' : 'text-[#5E5A72]'}`}>02/05/2025</p>
                  </div>
                </div>
              </div>

              {/* Cuadro 3 */}
              <div className={`${isDark ? 'bg-[#2D255A] border-[#333]' : 'bg-[#E9E2F7] border-gray-300'} p-6 rounded-xl shadow-md border`}>
                <p className={`${isDark ? 'text-gray-200' : 'text-gray-800'} italic mb-4`}>
                ...
                <div className="flex items-center gap-3">
                  ...
                  />
                  <div>
                    <p className={`font-medium ${isDark ? 'text-[#B088FF]' : 'text-[#7A4FBF]'}`}>Laura Jiménez, Profesora</p>
                    <p className={`text-sm ${isDark ? 'text-[#A0A0C0]' : 'text-[#5E5A72]'}`}>20/05/2025</p>
                  </div>
                </div>
              </div>

              {/* Cuadro 4 */}
              <div className={`${isDark ? 'bg-[#1C1B2E] border-[#333]' : 'bg-[#F0EEF9] border-gray-300'} p-6 rounded-xl shadow-md border`}>
                <p className={`${isDark ? 'text-gray-200' : 'text-gray-800'} italic mb-4`}>Quote</p>
                <div className="flex items-center gap-3">
                  <img src="https://randomuser.me/api/portraits/women/65.jpg" alt="Title" className="w-10 h-10 rounded-full object-cover" />
                  <div>
                    <p className={`font-medium ${isDark ? 'text-[#B088FF]' : 'text-[#7A4FBF]'}`}>Title</p>
                    <p className={`text-sm ${isDark ? 'text-[#A0A0C0]' : 'text-[#5E5A72]'}`}>00/00/00</p>
                  </div>
                </div>
              </div>

              {/* Cuadro 5 */}
              <div className={`${isDark ? 'bg-[#322F56] border-[#333]' : 'bg-[#F0EEF9] border-gray-300'} p-6 rounded-xl shadow-md border`}>
                <p className={`${isDark ? 'text-gray-200' : 'text-gray-800'} italic mb-4`}>Quote</p>
                <div className="flex items-center gap-3">
                  <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="Title" className="w-10 h-10 rounded-full object-cover" />
                  <div>
                    <p className={`font-medium ${isDark ? 'text-[#B088FF]' : 'text-[#7A4FBF]'}`}>Title</p>
                    <p className={`text-sm ${isDark ? 'text-[#A0A0C0]' : 'text-[#5E5A72]'}`}>00/00/00</p>
                  </div>
              ...
              {/* Cuadro 6 */}
              <div className={`${isDark ? 'bg-[#2D255A] border-[#333]' : 'bg-[#F0EEF9] border-gray-300'} p-6 rounded-xl shadow-md border`}>
                <p className={`${isDark ? 'text-gray-200' : 'text-gray-800'} italic mb-4`}>Quote</p>
                <div className="flex items-center gap-3">
                  <img src="https://randomuser.me/api/portraits/women/44.jpg" alt="Title" className="w-10 h-10 rounded-full object-cover" />
                  <div>
                    <p className={`font-medium ${isDark ? 'text-[#B088FF]' : 'text-[#7A4FBF]'}`}>Title</p>
                    <p className={`text-sm ${isDark ? 'text-[#A0A0C0]' : 'text-[#5E5A72]'}`}>00/00/00</p>
                  </div>
      ...
      <section id="contacto" className={`py-20 ${isDark ? 'bg-[#1C1B2E]' : 'bg-[#E9E2F7]'}`}>
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <h2 className={`text-3xl font-bold text-center mb-12 ${isDark ? 'text-white' : ''}`}>Contactos</h2>
            <div className="flex flex-wrap justify-center gap-8">
              {[
                { name: 'GitHub', url: 'https://github.com/evelinpulsara', img: 'https://cdn-icons-png.flaticon.com/512/25/25231.png' },
                { name: 'Email', url: 'https://outlook.office.com/mail/?deeplink=mail%2F0%2F%3Fnlp%3D0', img: 'https://toppng.com/uploads/preview/outlook-logo-png-1764x1490-117357613016jetuonqfr.webp' },
